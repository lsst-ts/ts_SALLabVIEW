	...
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="Tests" Type="Folder">
			...
			<Item Name="IDLFile" Type="Folder">
				<Item Name="TestCase" Type="Folder">
					<Item Name="testParseIDLFile.vi" Type="VI" URL="../../Tests/IDLFile/TestCase/testParseIDLFile.vi"/>
				</Item>
				<Item Name="testIDLFile.vi" Type="VI" URL="../../Tests/IDLFile/testIDLFile.vi"/>
			</Item>
			...
			<Item Name="ElementFactory" Type="Folder">
				<Item Name="TestCase" Type="Folder">
					<Item Name="testCreateElement.vi" Type="VI" URL="../../Tests/ElementFactory/TestCase/testCreateElement.vi"/>
				</Item>
				<Item Name="testElementFactory.vi" Type="VI" URL="../../Tests/ElementFactory/testElementFactory.vi"/>
			</Item>
			<Item Name="Elements" Type="Folder">
				<Item Name="Primitives" Type="Folder">
					<Item Name="Enum" Type="Folder">
						<Item Name="TestCase" Type="Folder">
							<Item Name="testCreateEnumArray.vi" Type="VI" URL="../../Tests/Elements/Primitives/Enum/TestCase/testCreateEnumArray.vi"/>
						</Item>
						<Item Name="testEnum.vi" Type="VI" URL="../../Tests/Elements/Primitives/Enum/testEnum.vi"/>
					</Item>
				</Item>
			</Item>
		...
		<Item Name="VIUpdate" Type="Folder">
			...
			<Item Name="UpdateViCtrl.vi" Type="VI" URL="../VIUpdate/UpdateViCtrl.vi"/>
			<Item Name="UpdateViMult.vi" Type="VI" URL="../VIUpdate/UpdateViMult.vi"/>
			<Item Name="rmViFromLib.vi" Type="VI" URL="../VIUpdate/rmViFromLib.vi"/>
			<Item Name="addViToLib.vi" Type="VI" URL="../VIUpdate/addViToLib.vi"/>
			<Item Name="saveViAndLib.vi" Type="VI" URL="../VIUpdate/saveViAndLib.vi"/>
		...
		<Item Name="Utilily" Type="Folder">
			<Item Name="buildPathFromStrArr.vi" Type="VI" URL="../Utilily/buildPathFromStrArr.vi"/>
